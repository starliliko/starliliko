...
- **无人机集成与飞行调参** — 参与基于 PX4 的室内自主无人机研发，实践级联控制环调参、ULog 飞行日志分析、振动诊断，以及视觉/激光 SLAM 定位工作流。
- **AI 辅助工程文档** — 设计配置驱动的文档生产流水线，包含角色化 Agent、状态机、提交绑定审核、人工批准门禁，以及 GitHub Issue/PR 协作。
- **机器人部署与制造** — 实践 ROS 2、Jetson 边缘计算平台、飞控与线束集成、硬件调试，以及可复现的 3D 打印制造流程。

以上经历来自实习环境。公开内容仅描述我参与的工程方法、职责和能力；公司源码、内部硬件细节、客户信息及项目数据均保持私有。
