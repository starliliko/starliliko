...
- **自主无人机** — PX4、ROS 2、Gazebo，以及 LiDAR/视觉感知与定位
- **嵌入式控制** — STM32、ESP32-S3、FreeRTOS、传感器接口与级联 PID 控制
- **系统集成** — 飞控固件、地面站、机械设计、软硬件联调、测试与故障分析

## 实习与工程经历

- **自主无人机产品研发与交付** — 参与商业室内无 GNSS 自主无人机产品研发与交付，负责 PX4 装调、ULog 分析、ROS 2 与 Orin 系统接入，修改 EKF2 源码实现 SLAM 主定位与光流失效兜底，并累计完成 20 余架次真机测试。
- **AI 辅助工程文档** — 设计配置驱动的文档生产流水线，包含角色化 Agent、状态机、提交绑定审核、人工批准门禁，以及 GitHub Issue/PR 协作。
- **机器人部署与制造** — 具备飞控、边缘计算平台与线束的整机集成和硬件调试经验，并实践 3D 打印制造、装配与迭代。

公开内容仅描述我参与的工程方法、职责和能力；相关公司源码、内部硬件细节、客户信息及性能数据保持私有。
...
持续构建可靠的无人机自主系统，将嵌入式控制、状态估计、机器人感知和可复现的工程流程连接起来。
