...
电子信息工程学生，专注自主无人机、嵌入式系统与机器人感知。  
Electronic Information Engineering student focused on autonomous UAVs, embedded systems, and robotic perception.

I enjoy taking systems from sensors and firmware to simulation, perception, and operator tools.

## What I work on

- **Autonomous UAVs** — PX4, ROS 2, Gazebo, and LiDAR/visual perception
...
- [Image dehazing and deraining toolkit](https://github.com/starliliko/image-dehaze-derain-toolkit) — PyQt5 desktop application with multiple enhancement algorithms and quantitative quality metrics.
...
Building reliable UAV autonomy systems that connect embedded control, state estimation, perception, and reproducible engineering workflows.
